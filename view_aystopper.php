...
//Принимаем переменную и очищаем ее
$go = clear_string($_GET["go"]);    
//Создаем свич страниц
switch ($go) {
    ...
    <body>
        <div id="block-body">
            ...
            ?>
                ...
                $count = mysql_query("SELECT COUNT(*) FROM table_products $query_aystopper",$link)or die(mysql_error($link));
                //сохраняем результат 
            ...
            If ($temp[0] > 0)
                ...
                <?php
                // запрос в БД
                $result = mysql_query("SELECT * FROM table_products $query_aystopper ORDER BY $sorting $qury_start_num ",$link) or die(mysql_error($link));
              ...
              <ul id="block-tovar-list">
                ...
                echo '</ul>';
                    ...
                    echo '<p id="error_cat">Товаров нет </p>';    
                }
                }  
                else {
                    echo '<p id="error_cat">Данная категория не неайдена </p>'; 
                        } 
