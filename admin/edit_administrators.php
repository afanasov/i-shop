...
<html>
    <head>
        ...
        <title>Панель управления - Редактор профиля администратора</title>
    </head>
    <body>
        <div id="block-body">
            <?php
            ...
            <div id="block-content">
                <div id="block-parameters">
                    <p id="title-page">Редактор профиля администратора</p>
                </div>
                <?php
                ...
                If (mysql_num_rows($result) > 0)
                {
                    ...
                    do
                    {
                        ...
                        if ($row["edit_news"] == "1") $edit_news = "checked";
                            ...
                            <form method="POST" id="form-info" >
                               ...
                               <div class="block-privilege">
                                   ...
                                   <ul class="privilege">
                                       <li><h3>Товары</h3></li>
                                       <li>
                                           <input type="checkbox" name="add_tovar" id="add_tovar" value="1" '.$delete_orders.' />
                               ...
                               <div class="block-privilege">
                                   ...
                                   <ul class="privilege">
                                       ...
                                       <li>
                                        ...
                                        <li>
                                           <input type="checkbox" name="edit_news" id="edit_news" value="1" '.$edit_news.' />
                                           <label for="edit_news">Изменение новостей.</label>
                                        </li>
                                   </ul>
                                   <ul class="privilege">
