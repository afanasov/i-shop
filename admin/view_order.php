<?php
    ...
    $_SESSION['urlpage'] = "<a href='index.php' >Главная</a> / <a>Просмотр заказов</a>";    
    ...
    if (isset($action))
    {
        switch ($action) 
        {
            case 'accept':
                ...
                $update = mysql_query("UPDATE orders SET order_confirmed='yes' WHERE order_id = '$id'",$link) or die(mysql_error($link));
                }  else 
            ...
            case 'delete':
                ...
                {
                    $delete = mysql_query("DELETE FROM orders WHERE order_id = '$id'",$link) or die(mysql_error($link)); 
                    header("Location: orders.php"); 
                }else
                { $msgerror = 'У вас нет прав на удаления данного заказа!'; }                   
            break;        
	} 
    }
?>
        ...
        <div id="block-body">
            ...
            <div id="block-content">
                ...
                <?php
                    ...
                    {                    
                        $result = mysql_query("SELECT * FROM orders WHERE order_id = '$id'",$link) or die(mysql_error($link));
                        ...
                        If (mysql_num_rows($result) > 0)
                        {
                            ...
                            ';
                            $query_product = mysql_query("SELECT * FROM buy_products,table_products WHERE buy_products.buy_id_order = '$id' AND table_products.products_id = buy_products.buy_id_product",$link) or die(mysql_error($link));
                            ...
                            echo '
                                    ...
                                    <ul id="info-order">
                                        <li>Итого - <span>'.$price.'</span> грн</li>
