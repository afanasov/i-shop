    ...
    <body>
        <div id="block-body">
            ...
            <div id="block-content">                
                    ...
                    <ul id="options-list">                        
                        ...
                        <li><a id="select-sort"><?php echo $sort_name; ?></a>                        
                            ...
                            <ul id="sorting-list">                            
                                ...
                                <li><a href="index.php?sort=brand">От Я до А</a></li>
                            </ul>                       
                        </li>
                    </ul>                   
                </div>                
                ...
                // запрос в БД
                $result = mysql_query("SELECT * FROM table_products WHERE visible='1' ORDER BY $sorting $qury_start_num ",$link) or die(mysql_error($link));                               
