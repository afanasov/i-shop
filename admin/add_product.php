<?php
    ...
    $_SESSION['urlpage'] = "<a href='index.php' >Главная</a> / <a href='tovar.php' >Товары</a> / <a href='add_product.php' >Добовление товара</a>";    
    ...
    {   if($_SESSION['add_tovar'] == '1')
        {
            ...
            {                           
              		mysql_query("INSERT INTO table_products(title,price,brand,seo_words,seo_description,mini_description,description,mini_features,features,new,leader,sale,visible,availability,type_tovara,brand_id,datatime)
						VALUES(						
                            '".$_POST["form_title"]."',
                            '".$_POST["form_price"]."',
                            '".$selectbrand."',
        ...
        }  else {$msgerror = 'У вас нет прав на добавления данного товара!';}
    }           
?>
            ...
            <div id="block-content">
               ...
               <form enctype="multipart/form-data" method="POST">
                    ...
                    <ul id="chkbox">
                        ...
                        <li><input type="checkbox" name="availability" id="chk_sale"  /><label for="availability" >Наличие</label></li>
                    </ul> 
